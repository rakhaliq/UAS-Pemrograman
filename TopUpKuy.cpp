...
class backto{  //class yang menyimpan fungsi untuk kembali ke menu utama
	public:
		void backtomainmenu();
};
...
class TampilanMenuUtama{  //class yang menyimpan fungsi untuk menampilkan menu utama
	public:
		void mainmenu();
};

void TampilanMenuUtama :: mainmenu() {  //definisi fungsi untuk menampilkan mainmenu() dari class TampilanMenuUtama
	daftarGame game; //objek dari class daftarGame
	backto kembalikeMenuawal;
	system ("cls");  //untuk membersihkan tampilan sebelumnya
	cout<<" ================================================"<<endl;
	...
	if (game.pilih == 1){
		...
		kembalikeMenuawal.backtomainmenu();  //menampilkan fungsi yang menampilkan pilihan untuk kembali kemenu utama atau tidak
	}
	else if (game.pilih == 2){
		game.MenuAoV(); //memanggil fungsi yang menampilkan fungsi menuAoV yang ada pada class daftarGame
		kembalikeMenuawal.backtomainmenu(); //memanggil fungsi yang menampilkan pilihan untuk kembali ke menu utama atau tidak
	}
...
void backto :: backtomainmenu() { //definisi fungsi yang digunakan untuk kembali ke mainmenu pada class backto
	TampilanMenuUtama tampilanMenu;
	char pilihan;
	...
	if (pilihan == 'y'){
		tampilanMenu.mainmenu(); //fungsi yang digunakan untuk kembali ke menu utama
	}
	else{
...
int main(){  //fungsi main
   	TampilanMenuUtama tampilanMenu;
	tampilanMenu.mainmenu(); //fungsi mainmenu untuk menampilkan menu utama dan menjalankan program
